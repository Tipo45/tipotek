    ...
    <section id="projects">
      ...
      <div className="p-4 grid grid-cols-1 tablet:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="px-8 mt-15">
          ...
          <p className="text-gray-300 text-md mt-4" data-aos="fade-up"
            data-aos-delay="800">
            I developed a secure ticket management system to streamline event ticketing processes. This full-stack system enables users to browse events, purchase tickets, and manage their bookings with features like real-time availability tracking and secure payment processing. Built with React.js and PocketBase, it offers role-based access, and responsive dashboards for both desktop and mobile use.
          </p>
          <div className="mt-8">
            <Link
