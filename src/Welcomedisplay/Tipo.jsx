  ...
  return (
    <section>
      <div className="grid grid-cols-1 gap-2 tablet:grid-cols-2 mt-15 p-4">
        <div className="p-8">
          <div className="mb-8">
            <p className="flex text-lg text-gray-500">
              Hi, I&apos;m Tipo{" "}
            ...
            <h1 className="text-2xl/10 font-medium font-primary">
              A Nigerian-based Web Developer passionate about developing
              functional, intuitive websites for seamless user experiences.
            </h1>
          </div>
          <div className="space-y-4 space-x-6 mt-5">
            <button className="relative cursor-pointer outline-none p-4 rounded-2xl border-2 border-transparent overflow-hidden group bg-gray-100 font-medium text-black text-xl hover:bg-emerald-green hover:text-white transition-colors duration-300 ease-in-out">
            ...
            >
              <button className="p-4 cursor-pointer bg-gray-200 hover:bg-black group rounded-full items-center justify-center w-14 h-14">
