      ...
      <div className="grid grid-cols-1 gap-2 tablet:grid-cols-2 mt-15 p-4">
        <div className="p-8">
          ...
          <div className="space-y-4 space-x-6 mt-5">
            <Link to="/">
              <button
                className="relative cursor-pointer outline-none p-4 rounded-2xl border-2 border-transparent overflow-hidden group bg-gray-100 font-medium text-black text-xl hover:bg-emerald-green hover:text-white transition-colors duration-300 ease-in-out"
                data-aos="fade-right"
                data-aos-delay="1700"
              >
